...
export class PsdFile {
    ...
    _createLayerBlockBuffer(psd) {
        ...
        layerInfoHeader.writeUInt32BE(layerInfoLength - 4,0); // Length of the layers info
        ...
        globalLayerMaskInfo.writeUInt32BE(globalLayerMaskInfoSize - 4,0); // length
        ...
        layerHeader.writeUInt32BE(layerLength,0); // Length of the layer section
        // layer data
